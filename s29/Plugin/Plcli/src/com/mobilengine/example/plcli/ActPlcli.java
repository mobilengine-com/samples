...
import com.mobilengine.android.fdx.client.Fcb;
import com.mobilengine.android.fdx.client.FcbBinderWrp;
import com.mobilengine.android.fdx.client.FdxBinderWrp;
import com.mobilengine.android.fdx.client.FdxRemote;
import com.mobilengine.android.fdx.client.Kfin;
import com.mobilengine.android.fdx.client.Krlt;
import com.mobilengine.android.fdx.client.QueryParams;
...
public class ActPlcli extends Activity
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		U.addOnClick(this, R.id.btnSet, new Callable<Void>()
		{
		...
		U.addOnClick(this, R.id.btnAddRow, new Callable<Void>()
		{
		...
		U.addOnClick(this, R.id.btnDelRow, new Callable<Void>()
		{
		...
		U.addOnClick(this, R.id.btnPhoto, new Callable<Void>()
		{
		...
		U.addOnClick(this, R.id.btnCrash, new Callable<Void>()
		{
		...
		U.addOnClick(this, R.id.btnAnr, new Callable<Void>()
		{
		...
		U.addOnClick(this, R.id.btnSendPhoto, new Callable<Void>()
		{
			@Override
			public Void call()
			{
		...
		U.addOnClick(this, R.id.btnUnbind, new Callable<Void>()
		{
		...
		U.addOnClick(this, R.id.btnDiscard, new Callable<Void>() {
			@Override
			public Void call() throws Exception {
				fdxRemote.discard();
				return null;
		...
		U.addOnClick(this, R.id.btnSubmit, new Callable<Void>() {
			@Override
			public Void call() throws Exception {
				Krlt krlt = fdxRemote.submit();
				Toast.makeText(ActPlcli.this, "Krlt:" + krlt.name(), Toast.LENGTH_LONG).show();
				return null;
			}
		});
		
		U.addOnClick(this, R.id.btnQuery, new Callable<Void>() {
			@Override
			public Void call() throws Exception {
				Object[] params = new Object[] { 1, 1L, 1.1f, 1.1d, true, "hello", null };
				Object[][] result = fdxRemote.query("SELECT ?, ?, ?, ?, ?, ?, ?", new QueryParams(params)).contents;
				Toast.makeText(ActPlcli.this, "Query done", Toast.LENGTH_LONG).show();
				return null;
			}
		});
		...
		try {
			fdxRemote.registerCallback(new FcbBinderWrp(new Fcb.Stub() {
				@Override
				public void onFormClose(Kfin kfin, String onpthButton) throws RemoteException {
					final String msg = "onFormClose: kfin:" + kfin + " onpthButton:" + onpthButton;
					Log.w("Plcli", msg);
					ActPlcli.this.runOnUiThread(new Runnable() {
						@Override
						public void run() {
							Toast.makeText(ActPlcli.this, msg, Toast.LENGTH_LONG).show();
						}
					});
				}
			}));
		} catch (Exception e) {
			Toast.makeText(ActPlcli.this, "Cannot register for onFormClose: " + e.getMessage(), Toast.LENGTH_LONG).show();
		}
